import psycopg2, pygame, json
from game_objects import Player, Food, Wall

conn = psycopg2.connect("dbname=snake_game user=postgres password = postgres")
cur = conn.cursor()

with open('C:\pp2\lab10\snake\color.json') as f: # take colors from json file
...
pygame.display.set_caption('Snake_tolkyn')
